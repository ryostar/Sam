...
if ENV:
    ...
    from samantha.config import Development as Config
...
client = TelegramClient("samantha", api_id, api_hash)

#Pyrogram
pbot = Client("SamanthaPyro", api_id=TELETHON_ID, api_hash=TELETHON_HASH, bot_token=TOKEN)
...
from samantha.modules.helper_funcs.handlers import CustomCommandHandler
